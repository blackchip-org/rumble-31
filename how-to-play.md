This game uses a standard 52-card deck of playing cards. Cards ranked
2 through 6 are removed from the deck before play starts.

A player is randomly selected as the first dealer. Three cards are
...
- Trade a card from their hand with a card from the pot
- Knock
- Knock, and trade their entire hand for the pot

When a player knocks, all other players get one more turn before the round
ends.

Each hand is scored by adding the values of same suit cards together. Values
are:

- 7 through 10: Numeric value
